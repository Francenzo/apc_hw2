...
int main(int argc, char **argv)
{
  ...
  if (strcmp(autoname, "serial") == 0)
  {
    ...
    if (b2 < 1.3)
      ...
      grade = 75.00 + (1.5 - b2) / (0.2) * 25.00;
    else if (b2 < 2)
      grade = (2 - b2) / 0.5 * 75.00;
    else
      grade = 0.0;
  ...
  if (strcmp(autoname, "pthreads") == 0 || strcmp(autoname, "openmp") == 0 || strcmp(autoname, "mpi") == 0)
  {
    ...
    if (sse_avg > 0.8)
      ...
      ssgrade = 75.00 + 25.00 * (sse_avg - 0.5) / 0.3;
    else
      ssgrade = sse_avg / 0.5 * 75.00;

    if (ws_avg > 0.8)
      wsgrade = 100.00;
    else if (ws_avg > 0.5)
      wsgrade = 75.00 + 25.00 * (ws_avg - 0.5) / 0.3;
    else
      wsgrade = ws_avg / 0.5 * 75.00;
